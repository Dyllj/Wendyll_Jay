...
const SkillCard = ({ title, skills, icon: Icon }) => {
  return (
    <div className="group flex flex-col justify-start items-start gap-2 w-full sm:w-md h-auto sm:h-56 duration-500 relative rounded-lg p-4 bg-amber-600 hover:shadow-lg shadow-zinc-400">
      <div className="absolute duration-700 shadow-md group-hover:-translate-y-2 group-hover:-translate-x-2 -bottom-8 sm:-bottom-10 -right-8 sm:-right-10 w-20 h-20 sm:w-1/3 sm:h-1/3 rounded-lg bg-gray-200 flex items-center justify-center">
