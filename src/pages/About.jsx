...
const About = () => {
  return (
    <ScrollFadeIn>
      <section id="about" className="max-w-screen bg-amber-600 w-7xl mb-16 h-auto py-10 rounded-lg">
        <article className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-8">
          <div className="w-full px-4 sm:px-6 lg:px-8">
            ...
            <section className="w-fullp-6  flex gap-10">
              ...
              <aside className=" p-5 rounded-lg w-full max-w-sm h-fit">
                <h3 className="text-xl font-semibold mb-4 text-gray-800">Key Facts</h3>
                <ul className="space-y-3">
                  <li className="flex items-center text-center text-gray-700 bg-zinc-200 w-50 p-2 rounded-xl hover:bg-zinc-800 hover:text-zinc-200 transition-all ease-in-out cursor-pointer">
                    IOT Development
                  </li>
                  <li className="flex items-center text-gray-700 bg-zinc-200 w-full p-2 rounded-xl hover:bg-zinc-800 hover:text-zinc-200 transition-all ease-in-out cursor-pointer">
                    UI/UX Design
                  </li>
                  <li className="flex items-center text-gray-700 bg-zinc-200 w-full p-2 rounded-xl hover:bg-zinc-800 hover:text-zinc-200 transition-all ease-in-out cursor-pointer">
